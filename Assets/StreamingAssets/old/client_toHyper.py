...
def metadata_json_output(metadata):
    print("MET "+metadata.transcripts[0].tokens[0].text)
    json_result = dict()
...
def main():
    ...
    if args.extended:
        ...
        metadata = ds.sttWithMetadata(audio, 1)
    #    print("Han salido "+str(len(metadata))+" transcripciones posibles")
    #    print("las siguientes confianzas:")
    #    for i, id in enumerate(metadata):
    #        print(str(i)+" "+str(id.confidence))
    #    print(metadata_json_output(metadata))
        ...
        hyper.write("Executed with alpha="+str(args.lm_alpha)+", beta="+str(args.lm_beta))
        hyper.write("\nResults")
        hyper.write("\n\t opciones: "+str(len(metadata_global.transcripts)))
        for id, t in enumerate(metadata_global.transcripts):
            hyper.write("\n\t ("+str(id)+") confianza "+str(t.confidence))
        hyper.write("\n\n")
